...
Sauf précisions contraires dues à une configuration spécifique, vous pouvez appeler ce point api à plusieurs occasions :

1) lors de la préparation de la commande, en ajoutant uniquement les `Lignes` et en ne précisant que la quantité préparée sur celles-ci. Le bon de prépa sera alors amené à l'étape "Préparé"
